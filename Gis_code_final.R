...
#Due to the Airbnb listing is too large, I upload the csv2.csv to the Github and onedrive.
#write.csv(csv2,"C:/Users/Dell/Desktop/csv2.csv",row.names = FALSE)
#csv2 <- read_csv("C:/Users/DeLL/Desktop/csv2.csv")
